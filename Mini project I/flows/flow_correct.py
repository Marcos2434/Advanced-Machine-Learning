    ...
    for epoch in range(epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            if save_path:
                ...
                }, save_path + f'{args.data}_train-loss={train_losses[-1]:.0f}_val-loss={val_losses[-1]:.0f}_epoch={epoch}_bs={args.batch_size}_mask={args.mask_type}_trans={args.num_trans}_hidden={args.num_hidden}.pt')
